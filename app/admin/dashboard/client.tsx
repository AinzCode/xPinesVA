...
export default function DashboardClient({ initialStats }: AdminDashboardClientProps) {
  ...
  const dashboardStats = [
    {
      ...
      change: '+12.5%',
      changeType: stats.pendingInquiries > 5 ? ('positive' as const) : ('neutral' as const),
      icon: MessageSquare,
      color: 'text-[#052814]',
    ...
    },
    {
      ...
      change: '+6.2%',
      changeType: stats.publishedBlogPosts > 0 ? ('positive' as const) : ('neutral' as const),
      icon: FileText,
      color: 'text-blue-600',
