...
export const metadata: Metadata = {
  ...
  description: 'Professional Medical Virtual Assistant (MVA) services for clinics, healthcare providers, and medical businesses.',
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 lg:pt-32 pb-12">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our Medical Virtual Assistants (MVA) provide specialized healthcare support for clinics, 
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-10">
          {/* Services Overview */}
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-6">What Our Medical Virtual Assistants (MVA) Can Do</h2>
