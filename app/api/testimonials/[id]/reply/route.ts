...
export async function POST(request: NextRequest) {
  try {
    ...
    const { testimonialId, subject, message, recipientEmail, recipientName } = body;

    // Validate required fields
    if (!testimonialId || !subject || !message || !recipientEmail || !recipientName) {
      return NextResponse.json(
          ...
          <body>
            <div class="container">
              ...
              <div class="reply-info">
                <p>⭐ Thank you for your testimonial! Here's our response:</p>
              </div>
              ...
              <div class="footer">
                ...
                <p style="margin-top: 10px;">
                  You received this email because you submitted a testimonial through our website.
                </p>
              </div>
            </div>
          </body>
    ...
    console.error('Error in send testimonial reply API:', error);
    return NextResponse.json(
