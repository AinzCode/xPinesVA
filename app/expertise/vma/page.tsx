...
import { ArrowLeft, CheckCircle, Heart, Clock, Shield } from 'lucide-react'
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <Link href="/expertise" className="text-red-600 hover:underline">Expertise</Link>
            <span className="text-gray-400">/</span>
            <span className="text-gray-600">Virtual Medical Assistant</span>
          </div>
        </div>
      </div>
